...
You'll need to create a bucket in S3 to store the `.tfstate` files that get generated by Terraform during deployment. Make
a note of the name of this bucket.
