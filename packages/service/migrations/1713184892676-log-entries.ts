...
export class LogEntries1713184892676 implements MigrationInterface {
  name = 'LogEntries1713184892676';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "log_entries" ("id" uuid NOT NULL, "logNumber" integer, "timestamp" TIMESTAMP NOT NULL, "entryTime" character varying(20) NOT NULL, "timezone" text NOT NULL, "bottomTime" integer, "duration" integer, "maxDepth" double precision, "maxDepthUnit" "public"."log_entries_maxdepthunit_enum", "notes" text, "ownerId" uuid, "siteId" uuid, CONSTRAINT "PK_b226cc4051321f12106771581e0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
