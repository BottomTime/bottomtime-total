...
export class Init1709581448101 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user_certifications" ("id" uuid NOT NULL, "agency" character varying(100) NOT NULL, "course" character varying(200) NOT NULL, "date" character varying(10), "userId" uuid, CONSTRAINT "PK_9951122e9d864429886105c6448" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL, "avatar" character varying(150), "bio" character varying(1000), "birthdate" character varying(10), "customData" json, "depthUnit" "public"."users_depthunit_enum" DEFAULT 'm', "email" character varying(50), "emailLowered" character varying(50), "emailVerified" boolean NOT NULL DEFAULT false, "emailVerificationToken" character varying(50), "emailVerificationTokenExpiration" TIMESTAMP, "experienceLevel" character varying(50), "isLockedOut" boolean NOT NULL DEFAULT false, "lastLogin" TIMESTAMP, "lastPasswordChange" TIMESTAMP, "location" character varying(50), "memberSince" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(100), "passwordHash" character varying(100), "passwordResetToken" character varying(100), "passwordResetTokenExpiration" TIMESTAMP, "pressureUnit" "public"."users_pressureunit_enum" DEFAULT 'bar', "profileVisibility" "public"."users_profilevisibility_enum" DEFAULT 'friends', "temperatureUnit" "public"."users_temperatureunit_enum" DEFAULT 'C', "role" "public"."users_role_enum" NOT NULL DEFAULT 'user', "startedDiving" character varying(10), "username" character varying(50) NOT NULL, "usernameLowered" character varying(50) NOT NULL, "weightUnit" "public"."users_weightunit_enum" DEFAULT 'kg', CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "dive_sites" ("id" uuid NOT NULL, "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "updatedOn" TIMESTAMP DEFAULT now(), "name" character varying(200) NOT NULL, "description" character varying(2000), "depth" double precision, "depthUnit" "public"."dive_sites_depthunit_enum", "location" character varying(200) NOT NULL, "directions" character varying(500), "gps" geometry NOT NULL, "freeToDive" boolean, "shoreAccess" boolean, "creatorId" uuid, CONSTRAINT "PK_0a067f7ec8dac38250a17c76a59" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "dive_site_reviews" ("id" uuid NOT NULL, "createdOn" TIMESTAMP NOT NULL DEFAULT now(), "updatedOn" TIMESTAMP DEFAULT now(), "title" character varying(200) NOT NULL, "rating" double precision NOT NULL, "difficulty" double precision, "comments" character varying(1000), "creatorId" uuid, "siteId" uuid, CONSTRAINT "PK_1698470d7b7644b0f0ebb4d14a1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
