...
const UserData: UserDTO = {
  ...
  hasPassword: true,
  isLockedOut: false,
  lastLogin: new Date('2021-08-01T00:00:00.000Z').valueOf(),
  lastPasswordChange: new Date('2021-08-01T00:00:00.000Z').valueOf(),
  memberSince: new Date('2021-08-01T00:00:00.000Z').valueOf(),
  role: UserRole.User,
  username: 'j.bard43',
  profile: {
    accountTier: AccountTier.Basic,
