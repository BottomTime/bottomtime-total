...
export const BasicUser: UserDTO = {
  ...
  hasPassword: true,
  isLockedOut: false,
  lastLogin: new Date('2021-01-01T00:00:00.000Z').valueOf(),
  lastPasswordChange: new Date('2021-01-01T00:00:00.000Z').valueOf(),
...
export const UserWithFullProfile: UserDTO = {
  ...
  isLockedOut: false,
  memberSince: new Date('2017-12-29T17:03:07.671Z').valueOf(),
  profile: {
    accountTier: AccountTier.Basic,
    avatar:
...
export const UserWithEmptyProfile: UserDTO = {
  ...
  isLockedOut: false,
  memberSince: new Date('2022-01-25T11:40:20.928Z').valueOf(),
  profile: {
    accountTier: AccountTier.Basic,
    memberSince: new Date('2022-01-25T11:40:20.928Z').valueOf(),
