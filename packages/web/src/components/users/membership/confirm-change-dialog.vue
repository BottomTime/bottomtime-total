<template>
  ...
  >
    <div class="flex gap-3">
      <span class="my-3">
        <i class="fa-regular fa-circle-question text-5xl"></i>
      </span>

      <div class="space-y-6">
        <p class="text-justify">
          You are about to change your current membership tier. Please review
          the change below and confirm your action.
        </p>
        ...
        <p class="text-sm text-justify text-warn">
          ...
          <span class="italic">
            Your current membership will be prorated and you will be refunded
            for the time remaining on it. You will be charged for the new
            membership at the same time. These charges will appear together as
            single charge/refund on your credit card statement. An invoice will
            be emailed to you detailing the change.
          </span>
        </p>
      </div>
    </div>
