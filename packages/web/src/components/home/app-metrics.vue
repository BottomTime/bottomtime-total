<template>
  <FormBox class="space-y-3 shadow-lg">
    ...
    <div v-if="state.metrics" class="flex gap-3 justify-between">
      <div class="space-y-2 text-center">
        ...
        <div>
          ...
          <p class="text-lg font-mono text-success">
            {{ state.metrics.users.activeLastMonth }}
          </p>
        </div>
      </div>
      ...
      <div class="space-y-2 text-center">
        ...
        <div>
          ...
          <p class="text-lg font-mono text-success">
            {{ state.metrics.logEntries.total }}
          </p>
        </div>
        ...
        <div>
          ...
          <p class="text-lg font-mono text-success">
            {{ state.metrics.logEntries.addedLastWeek }}
          </p>
        </div>
        ...
        <div>
          ...
          <p class="text-lg font-mono text-success">
            {{ state.metrics.logEntries.addedLastMonth }}
          </p>
        </div>
      </div>
    </div>
